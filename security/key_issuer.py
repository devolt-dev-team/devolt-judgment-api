...
from blueprint.helper import _generate_hmac_key, validate_hmac_key
...
if __name__ == "__main__":
    ...
    if not SECRET_KEY:
        raise RuntimeError("API_SECRET_KEY is not set in the environment variables.")
